export default {
  "zh-CN": {
    ...
    "field.name": "任务名称",
    "field.account": "用户账号",
    "field.account_hint": "Linux 环境仅可选择系统组的账号；Windows 环境默认使用当前登录账号",
    "field.trigger": "触发方式",
    "trigger.schedule": "定时",
    "trigger.event": "事件",
    "trigger.manual": "手动",
  ...
  "en": {
    ...
    "field.account_hint": "On Linux choose system accounts; on Windows current user is used.",
    ...
    "msg.blocked_n": "{n} tasks blocked waiting for dependencies",
